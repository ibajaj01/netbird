...
- **[Azure Kubernetes Service (AKS) with Microsoft Entra](./README-AKS.md)** - Complete guide for deploying Netbird on AKS with Azure Active Directory authentication
- **[Quick Start for AKS](./QUICKSTART-AKS.md)** - 15-minute quick deployment guide
- **[Example Configurations](./examples/)** - Various deployment examples including nginx-ingress, istio, and traefik
